...
public class VEItemPickaxe extends ItemPickaxe implements IQualitizer{
	...
	public VEItemPickaxe(ToolMaterial material) {
		super(material);
	}
	...
	public void getRandomToolQuality(ItemStack item, ToolMaterial material, EntityPlayer player) {
		...
		if(quality<=masChanceThreshold) {
			...
			player.addChatMessage(new ChatComponentTranslation("msg.masterful_pickaxe.txt"));
		} 
